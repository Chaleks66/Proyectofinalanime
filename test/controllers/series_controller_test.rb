...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Serie.count') do
      post series_url, params: { series: { genre: @series.genre, img: @series.img, name: @series.name, status: @series.status, year: @series.year } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { genre: @series.genre, img: @series.img, name: @series.name, status: @series.status, year: @series.year } }
